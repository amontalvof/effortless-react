...
`useScript` is a hook that dynamically load an external script in one line. It can be super useful when you need to integrate a third party library like **Google Analytics** or **Stripe**.
